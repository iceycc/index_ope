...
(function(jq){
    ...
    posterTvGrid.prototype = {
        reset: function(options){
            ...
            this.preLeft = 0;
            this.nextLeft = this.options.width/2;
            this.preNLeft = -530;
            this.nextNLeft = this.options.width;
            this.pageNowLeft = (this.options.width-746)/2
            this.drawContent();
        },
        drawContent: function(){
            ...
            var bottomNavText = ['客厅','卫生间','厨房','卧室'];
            for(var i=1; i<= this.total; i++){
                var bottomItem = document.createElement("DIV");
                bottomItem.className = "bottomNavButtonOFF bottomNavButtonOFF"+(i);
                bottomItem.innerHTML = bottomNavText[i-1];
                if(i == this.pageNow){
                    bottomItem.className = "bottomNavButtonOFF bottomNavButtonON bottomNavButtonOFF"+i;
                }
            ...
            for(var item=0, i = 1, l= this.data.length ; item < l ; ++item, ++i){
                ...
                contentHolderUnit.style.cursor = 'auto';
        ...
        initContent: function(){
            ...
            this.parent.find(".contentHolderUnit:nth-child("+this.pageNow+")").css({width:this.activeWidth,height:this.activeHeight, opacity: 1, left: this.pageNowLeft+'px', zIndex: 3, marginTop: 0});
            ...
            this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: this.HeightDefaule, width: this.WidthDefaule, zIndex: 0, marginTop: '23px'});
            ...
            this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: this.HeightDefaule, width: this.WidthDefaule, zIndex: 0, marginTop: '23px'});
        ...
        turn: function(dir){
            ...
            if(dir == "right"){
                ...
                // console.log(page)
                if(page <= 0) {
                    page = _this.pageNow + 1;
                    this.options.prevFn&&this.options.prevFn(page);
                }else{
                ...
                if(page > _this.total){
                    var page = _this.pageNow -1;
                    //alert(2);
                    this.options.nextFn&&this.options.nextFn(page);
                }else{
                    _this.turnpage(page, dir);
                }
        ...
        turnpage: function(page, dir){
            ...
            var run = function(page, dir, t){
                ...
                if(dir == 'left'){
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: _this.HeightDefaule, width: _this.WidthDefaule, zIndex: 2, marginTop: '23px'}, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: _this.activeHeight, width:_this.activeWidth, zIndex: 3, marginTop: '0'}, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 0, left: _this.nextNLeft+'px', height: '100px', width: _this.WidthDefaule, zIndex: 2, marginTop: '85px'});
                    _this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: _this.HeightDefaule, width:_this.WidthDefaule, zIndex: 2, marginTop: '23px'}, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+preP+")").animate({width:_this.WidthDefaule,height:'100px', opacity: 0, left:_this.preNLeft+'px', zIndex:0, marginTop: '85px'},t, "", function(){_this.locked=false;});
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: _this.activeHeight, width: _this.activeWidth, zIndex: 3, marginTop: '0px'}, t);
                    _this.parent.find(".contentHolderUnit:nth-child("+page+") .elementOverlay").css({opacity:0});
                    _this.parent.find(".contentHolderUnit:nth-child("+page+") .leftShadow").css({opacity:1});
                    _this.parent.find(".contentHolderUnit:nth-child("+page+") .rightShadow").css({opacity:1});

                    _this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 0, left: _this.preNLeft+'px', height: '100px', width: _this.WidthDefaule, zIndex: 2, marginTop: '85px'});
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: _this.HeightDefaule, width: _this.WidthDefaule, zIndex: 2, marginTop: '23px'}, t);
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+") .elementOverlay").css({opacity:0.4});
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+") .leftShadow").css({opacity:0});
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+") .rightShadow").css({opacity:0});
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+nextN+")").animate({width:_this.WidthDefaule,height:'100px', opacity: 0, left:_this.nextNLeft+'px', zIndex:0, marginTop: '85px'}, t, "",function(){_this.locked=false;});
                }
